...
class AnyCloud:
  ...
  def evt_read_certificate(self) :
    ...
    cmd_line = "openssl x509 -in RootCA.PEM -text"
    ...
    print("\r\n[*** The root certificate has been saved into the file 'RootCA.PEM' ***]")   
  ...
  def runApp(self):
    ...
    if self.app_state == 0:  # start of application
      print("\r\n--------------------------------------------------------------------------------")
      print("Reading WFI32 Root Certificate")
      print("--------------------------------------------------------------------------------")
      self.app_state = 1
